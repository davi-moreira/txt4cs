...
![Chico PDF](images/chico_pdf.jpg){width=500px}
...
![Tiririca - 2222](images/santinho-tiririca.jpg){width=600px}
...
O áudio que vamos usar é o que segue: `r embed_audio("audio")`.
...
```{r eval=F, echo=F, message=FALSE, warning=FALSE, cache=T}

audio_csv <- "https://raw.githubusercontent.com/davi-moreira/txt4cs/master/data/tiririca_campanha.csv"

transcricao <- gl_speech(audio_csv, sampleRateHertz = 44100L, languageCode = "pt-BR")
